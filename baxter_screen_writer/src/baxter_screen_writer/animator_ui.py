...
#
# Created: Sat Dec 20 15:20:57 2014
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gridLayout.addWidget(self.confusionValueSlider, 10, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.horizontalSlider_2, 6, 1, 1, 1)
        ...
        self.currentValueSlider = QtGui.QSlider(self.centralwidget)
        self.currentValueSlider.setEnabled(True)
        self.currentValueSlider.setOrientation(QtCore.Qt.Horizontal)
        self.currentValueSlider.setObjectName(_fromUtf8("currentValueSlider"))
        self.gridLayout.addWidget(self.currentValueSlider, 1, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.confusionTargetLabel, 3, 1, 1, 1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_12.setText(_translate("MainWindow", "More Confused", None))
        self.label_3.setText(_translate("MainWindow", "Set confusion", None))
        self.label_2.setText(_translate("MainWindow", "More Confused", None))
        self.label_10.setText(_translate("MainWindow", "Less Confused", None))
        ...
        self.label_4.setText(_translate("MainWindow", "Confusion Target", None))
        self.label_6.setText(_translate("MainWindow", "More Confused", None))
        self.label_9.setText(_translate("MainWindow", "Velocity", None))
