...
if(NOT "include" STREQUAL "")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      message(FATAL_ERROR "Project 'baxter_kinect_calibration' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/usr/local/${idir}'.  Ask the maintainer 'Michael Ferguson <mike@vanadiumlabs.com>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /usr/local/lib;/home/brawner/workspace/devel/lib;/opt/ros/hydro/lib)
...
foreach(depend ${depends})
  ...
  _pack_libraries_with_build_configuration(baxter_kinect_calibration_LIBRARIES ${baxter_kinect_calibration_LIBRARIES})
  _pack_libraries_with_build_configuration(_libraries ${${baxter_kinect_calibration_dep}_LIBRARIES})
  _list_append_deduplicate(baxter_kinect_calibration_LIBRARIES ${_libraries})
  # undo build configuration keyword merging after deduplication
  _unpack_libraries_with_build_configuration(baxter_kinect_calibration_LIBRARIES ${baxter_kinect_calibration_LIBRARIES})
